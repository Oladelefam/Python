    ...
    <div className="min-h-screen bg-bg-primary flex items-center justify-center p-4">
      ...
      <motion.div className="w-full max-w-md relative" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary">Sign in to continue your speaking journey</p>
        </div>
        <div className="glass rounded-2xl p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-text-secondary">Don't have an account? <Link to="/signup" className="text-accent hover:text-accent-light font-medium">Sign up free</Link></p>
          </div>
        </div>
      </motion.div>
    </div>
